    ...
    <Section>
      <Container>
        <Row className="justify-content-center pb-4">
          <Col lg="6">
            <Title variant="hero">
              Our mission is to inspire the human spirit with boba.
            </Title>
          </Col>
          <Col lg="6" className="pl-lg-5">
            <Text>
              Founded by Caelin Sutch, a student at UC Berkeley, Bobatime is on a mission to change people's lives one cup of delicious boba at a time.
